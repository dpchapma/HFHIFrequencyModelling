...
#define nrn_init _nrn_init__cadN
#define _nrn_initial _nrn_initial__cadN
#define nrn_cur _nrn_cur__cadN
#define _nrn_current _nrn_current__cadN
#define nrn_jacob _nrn_jacob__cadN
#define nrn_state _nrn_state__cadN
#define _net_receive _net_receive__cadN 
#define state state__cadN 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cadN", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define caninf caninf_cadN
 double caninf = 8e-05;
#define depth depth_cadN
 double depth = 0.1;
#define taurn taurn_cadN
 double taurn = 1;
 ...
 static double cani0 = 0;
 static double delta_t = 0.01;
 /* connect global user variables to hoc */
 static DoubScal hoc_scdoub[] = {
 "depth_cadN", &depth_cadN,
 "taurn_cadN", &taurn_cadN,
 "caninf_cadN", &caninf_cadN,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cadN /Users/danielchapman/PythonDev/Final/Mechanism/x86_64/cadN.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   drive_channel = - ( 10000.0 ) * ican / ( 2.0 * FARADAY * depth ) ;
   if ( drive_channel <= 0. ) {
     drive_channel = 0. ;
     }
   Dcani = drive_channel + ( caninf - cani ) / taurn ;
   }
 return _reset;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/danielchapman/PythonDev/Final/Mechanism/cadN.mod";
static const char* nmodl_file_text = 
  "\n"
  "NEURON {\n"
  "	SUFFIX cadN\n"
