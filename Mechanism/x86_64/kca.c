...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kca /Users/danielchapman/PythonDev/Final/Mechanism/x86_64/kca.mod\n");
...
static int  rates (  double _lcali ) {
   double _la ;
 _la = _lcali / b ;
   m_inf = _la / ( _la + 1.0 ) ;
   tau_m = taumin + 1.0 * 1.0 / ( _lcali + b ) ;
    return 0; }
 ...
 v=_v;
{
  ...
  cali = _ion_cali;
 { error =  states();
 if(error){fprintf(stderr,"at line 47 in file kca.mod:\n:	po = m\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/danielchapman/PythonDev/Final/Mechanism/kca.mod";
static const char* nmodl_file_text = 
