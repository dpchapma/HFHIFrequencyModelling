...
#define _ion_ican	*_ppvar[4]._pval
#define _ion_dicandv	*_ppvar[5]._pval
...
static void nrn_alloc(Prop* _prop) {
 ...
 prop_ion = need_memb(_can_sym);
 	_ppvar[4]._pval = &prop_ion->param[3]; /* ican */
 	_ppvar[5]._pval = &prop_ion->param[4]; /* _ion_dicandv */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "can_ion");
  hoc_register_dparam_semantics(_mechtype, 5, "can_ion");
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	hoc_register_cvode(_mechtype, _ode_count, _ode_map, _ode_spec, _ode_matsol);
 	hoc_register_tolerance(_mechtype, _hoc_state_tol, &_atollist);
 	hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 can /Users/danielchapman/PythonDev/Final/Mechanism/x86_64/can.mod\n");
...
static void _ode_matsol(_NrnThread* _nt, _Memb_list* _ml, int _type) {
 ...
 static void _update_ion_pointer(Datum* _ppvar) {
   ...
   nrn_update_ion_pointer(_can_sym, _ppvar, 4, 3);
   nrn_update_ion_pointer(_can_sym, _ppvar, 5, 4);
 }
 ...
 v=_v;
{
  ...
  eca = _ion_eca;
 { error =  states();
 if(error){fprintf(stderr,"at line 75 in file can.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }  }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/danielchapman/PythonDev/Final/Mechanism/can.mod";
static const char* nmodl_file_text = 
