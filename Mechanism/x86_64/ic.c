...
#define rates rates__mykca 
#define states states__mykca 
...
#define m_inf m_inf_mykca
 double m_inf = 0;
#define tau_m tau_m_mykca
 double tau_m = 0;
 ...
 "tau_m_mykca", &tau_m_mykca,
 "m_inf_mykca", &m_inf_mykca,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 mykca /Users/danielchapman/PythonDev/Final/Mechanism/x86_64/ic.mod\n");
...
/*CVODE*/
 ...
 {
   rates ( _threadargscomma_ v , cani ) ;
   Dm = ( m_inf - m ) / tau_m ;
   }
 return _reset;
}
 ...
 v=_v;
{
  ...
  cani = _ion_cani;
 { error =  states();
 if(error){fprintf(stderr,"at line 50 in file ic.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/danielchapman/PythonDev/Final/Mechanism/ic.mod";
static const char* nmodl_file_text = 
