...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 h /Users/danielchapman/PythonDev/Final/Mechanism/x86_64/h.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
   if ( _lv > - 30.0 ) {
     ...
     taun = 2.0 * ( 1.0 / ( exp ( ( _lv + 145.0 ) / - 17.5 ) + exp ( ( _lv + 16.8 ) / 16.5 ) ) + 5.0 ) ;
     }
   ninf = 1.0 - ( 1.0 / ( 1.0 + exp ( ( vhalf - _lv ) / K ) ) ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/danielchapman/PythonDev/Final/Mechanism/h.mod";
static const char* nmodl_file_text = 
