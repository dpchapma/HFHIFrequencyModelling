...
#define nrn_init _nrn_init__cadL
#define _nrn_initial _nrn_initial__cadL
#define nrn_cur _nrn_cur__cadL
#define _nrn_current _nrn_current__cadL
#define nrn_jacob _nrn_jacob__cadL
#define nrn_state _nrn_state__cadL
#define _net_receive _net_receive__cadL 
#define state state__cadL 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cadL", _hoc_setdata,
 0, 0
};
 /* declare global and static user variables */
#define calinf calinf_cadL
 double calinf = 0.0001;
#define depth depth_cadL
 double depth = 0.1;
#define taurl taurl_cadL
 double taurl = 2.5;
 ...
 "depth_cadL", &depth_cadL,
 "taurl_cadL", &taurl_cadL,
 "calinf_cadL", &calinf_cadL,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cadL /Users/danielchapman/PythonDev/Final/Mechanism/x86_64/cadL.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   drive_channel = - ( 10000.0 ) * ical / ( 2.0 * FARADAY * depth ) ;
   if ( drive_channel <= 0. ) {
     drive_channel = 0. ;
     }
   Dcali = drive_channel + ( calinf - cali ) / taurl ;
   }
 return _reset;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/danielchapman/PythonDev/Final/Mechanism/cadL.mod";
static const char* nmodl_file_text = 
  "\n"
  "NEURON {\n"
  "	SUFFIX cadL\n"
