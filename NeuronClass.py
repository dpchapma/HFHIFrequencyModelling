...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan  5 12:30:07 2021
...
load_mechanisms('/home/dpc53/CA1_Optimization/Final/Mechanism/')
h.load_file('/home/dpc53/CA1_Optimization/Final/Morphology/Neuron3Oblique.hoc')
#%% 
##############################################################################      
##############################################################################   
...
# */
                seg.h.gbar = gh_soma + (gh_end - gh_soma)/(1.0 + np.exp((h_dhalf-xdist)/h_steep))
...
############################################################################## 
        ...
        for sec in self.Trunk:
            ...
            dhalf = Ra_dhalf
            steep = Ra_steep
            sec.Ra = global_ra + (Ra_end - global_ra)/(1 + np.exp((Ra_dhalf-xdist)/Ra_steep)) # axial resistance
            sec.Ra = soma_ra
...
##############################################################################      
##############################################################################  
        self.NonTrunk = h.Cell[0].NonTrunk
